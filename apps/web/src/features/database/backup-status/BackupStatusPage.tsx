            ...
            <div className="flex flex-col items-start gap-4">
              ...
              {backupMode === "range" && (
                <div className="flex w-full flex-col gap-3">
                  <p className="text-sm font-medium leading-6 text-slate-600">
                    Hanya data pesanan, item pesanan, transaksi cohort, tracking, dan finance yang tanggalnya masuk rentang ini yang dicadangkan. Baris tanpa tanggal ikut disertakan agar tidak ada data yang tertinggal. Pelanggan, produk, channel, CS/tim, ekspedisi, dan data acuan lain tetap ikut lengkap (agar ID di data transaksi tetap bisa diterjemahkan).
                  </p>
