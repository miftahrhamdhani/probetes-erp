...
/**
 * Kartu submenu merah — dipakai di halaman utama tiap menu center.
 * Klik membuka halaman detail submenu (route terpisah), sama seperti pola
 * kartu submenu di Marketing (mis. Sales & Order Center).
 */
export function ModuleMenuCard({ menu }: { menu: ModuleMenuItem }) {
    ...
    >
      <div className="flex min-h-[94px] items-center gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 max-w-[280px] text-sm font-medium leading-5 text-white/80">{menu.description}</p>
        </div>
