...
export type PreviewKpiTone = "red" | "green" | "blue" | "amber" | "slate" | "purple";
...
const toneClass: Record<PreviewKpiTone, string> = {
...
/** Kartu KPI ringkas — dipakai di semua menu center (pola sama dengan Database). */
export function PreviewKpiCard({ item }: { item: PreviewKpiItem }) {
  return (
