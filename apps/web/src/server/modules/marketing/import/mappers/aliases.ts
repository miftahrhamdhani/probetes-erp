...
export const ADS_ALIASES = {
  ...
  adName: ["ad name", "nama iklan", "iklan", "product ads", "nama iklan produk"],
  ...
  impressions: ["impression", "impressions", "impresi", "tayangan"],
  clicks: ["click", "clicks", "klik", "klik tautan", "link clicks"],
